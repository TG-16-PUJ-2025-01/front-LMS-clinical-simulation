describe("Teacher flow tests", () => {
	...
	it("CORD-2 Acceso No Autorizado Coordinador", () => {
		...
		cy.visit("/coordinador/clases/1/practicas")
		cy.url().should("include", "/coordinador/clases/1/practicas")
		cy.get("h1").invoke("text").should("contain", "(20001) Semiología Clínica - 2025-10")

		cy.step("Step 3 - Revisar acceso a clase no autorizado")
		cy.visit("/coordinador/clases/3/practicas")
		...
		cy.get('button[type="submit"]').click()
		cy.url().should("include", "/coordinador/asignaturas")
		cy.visit("/coordinador/clases/1/calificaciones")
		cy.url().should("include", "/coordinador/clases/1/calificaciones")
		...
		cy.visit("/coordinador/clases/3/calificaciones")
		cy.url().should("include", "/login")
		cy.get("input#email").should("be.visible").and("have.attr", "placeholder", "Correo registrado")
		cy.get("input#password").should("be.visible").and("have.attr", "placeholder", "Contraseña")
		cy.get('button[type="submit"]').should("be.visible").and("contain", "Ingresar")
		...
		cy.get('button[type="submit"]').click()
		cy.url().should("include", "/coordinador/asignaturas")
		cy.visit("/coordinador/clases/1/miembros")
		cy.url().should("include", "/coordinador/clases/1/miembros")
		...
		cy.visit("/coordinador/clases/3/miembros")
		cy.url().should("include", "/login")
		cy.get("input#email").should("be.visible").and("have.attr", "placeholder", "Correo registrado")
		cy.get("input#password").should("be.visible").and("have.attr", "placeholder", "Contraseña")
		cy.get('button[type="submit"]').should("be.visible").and("contain", "Ingresar")
		...
		cy.get('button[type="submit"]').click()
		cy.url().should("include", "/coordinador/asignaturas")
		cy.visit("/coordinador/simulacion/1")
		cy.url().should("include", "/coordinador/simulacion/1")
		cy.get("h1").invoke("text").should("contain", "Práctica 1 (Grupo 1)")

		cy.step("Step 11 - Revisar acceso a listado de simulaciones no autorizadas")
		cy.visit("/coordinador/simulacion/16")
		cy.url().should("include", "/login")
		cy.get("input#email").should("be.visible").and("have.attr", "placeholder", "Correo registrado")
		cy.get("input#password").should("be.visible").and("have.attr", "placeholder", "Contraseña")
		cy.get('button[type="submit"]').should("be.visible").and("contain", "Ingresar")
		...
		cy.visit("/coordinador/asignaturas")
		cy.url().should("include", "/login")
		cy.get("input#email").should("be.visible").and("have.attr", "placeholder", "Correo registrado")
		cy.get("input#password").should("be.visible").and("have.attr", "placeholder", "Contraseña")
		cy.get('button[type="submit"]').should("be.visible").and("contain", "Ingresar")
	...
	it("CORD-1 Flujo completo de un coordinador", () => {
		...
		cy.step("Step 12 - Crear reserva y validar exito")
