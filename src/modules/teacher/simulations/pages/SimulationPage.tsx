...
import { CommentForm } from "@/modules/coordinator/simulations/components/CommentForm"
import { RubricForm } from "@/modules/coordinator/simulations/components/RubricForm"
        ...
        <NavBar
          navLinks={[
            ...
            // },
            {
              ...
              href: `/profesor/clases/${simulation?.practice?.classModel.classId}/practicas`,
            },
            {
              label: simulation?.practice?.name ?? "",
              href: `/profesor/clases/${simulation?.practice?.classModel.classId}/practicas/${simulation?.practice?.id}`,
            },
            {
              label: "Calificaciones",
              href: `/profesor/clases/${simulation?.practice?.classModel.classId}/calificaciones`,
            },
          ]}
        />
      </LayoutSlot>
